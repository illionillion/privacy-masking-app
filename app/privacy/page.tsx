  ...
  return (
    ...
    >
      ...
      <section className="space-y-3" aria-labelledby="privacy-cookies-heading">
        ...
        <p>
          本サイトの運用設定により、Google AdSense
          のスクリプトを読み込み、ディスプレイ広告（自動広告を含む）が表示されることがあります。
        </p>
        <p>
          当方が、AdSense とは別に当方単独の名義で第三者配信の広告用 Cookie
          を主目的とする広告タグやアクセス解析ツールのみを追加で設置することは、現時点では行っていません。
        </p>
        <p>
          Google AdSense を利用する場合、広告配信事業者・広告ネットワーク運営者等の第三者が、
          <strong>
