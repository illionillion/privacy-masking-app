  ...
  return (
    <LegalPageLayout title="利用規約" lastUpdatedLabel={LEGAL_DOCUMENT_LAST_UPDATED_LABEL}>
      ...
      <section className="space-y-3" aria-labelledby="terms-disclaimer-heading">
        ...
        <p>
          本サービスは現状有姿で提供されます。検出の漏れ・誤検出、編集結果の完全性、特定目的への適合性などについて、当方は一切保証しません。利用者は自己の責任において本サービスを利用し、公開・共有する前に内容を必ず確認してください。
        </p>
        <p>
          本サービスの利用または利用不能により生じた損害について、当方に故意または重過失がある場合を除き、当方は責任を負いません。
        </p>
      </section>
